...
findAuxiliaryPetriNodesTask path task = do
  ...
  paragraph $ translate $ do
    english [i|Translate the given activity diagram into a Petri net (on paper or in your head) and then state the total count of nodes (places and transitions, including auxiliary nodes),
