...
\item
  Are there transitions in conflict? Which?
\item
  Are there multiple transitions that are concurrently activated?
\item
...
\begin{itemize}
\item
  Add exactly one token somewhere so that two transitions become concurrently activated.
\item
  Remove a token so that there are no activated transitions anymore.
\item
...
\begin{itemize}
\item
  Change one incoming or outgoing weight of a transition (or add or remove an arrow) so that two transitions become concurrently activated.
\item
  Or: \dots\ so that there are no activated transitions anymore.
\item
