...
//draw petri net for given requirement without knowing anything about places and transitions

pred drawPConcurrency(){
   #Place = 3 and
...
run drawPConcurrency for 6
run drawPConcurrencyMultiple for 7
run drawPConflict for 5
