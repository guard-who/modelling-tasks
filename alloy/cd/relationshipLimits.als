...
pred smallerOrEqual [l, l2 : Limit] {
  not (l = Star)
...
pred smaller [l, l2 : Limit] {
  not l = l2 and smallerOrEqual [l, l2]
}
...
pred equalFromLimits [a, a2 : Limited] {
  a.fromLower = a2.fromLower
  a.fromUpper = a2.fromUpper
}

pred equalToLimits [a, a2 : Limited] {
  a.toLower = a2.toLower
  a.toUpper = a2.toUpper
}

pred equalLimits [a, a2 : Limited] {
  equalFromLimits [a, a2]
  equalToLimits [a, a2]
}
...
pred shiftedRangeUp [a, a2 : Limited] {
  shiftLimits [a.fromLower, a.fromUpper, a2.fromLower, a2.fromUpper] and equalToLimits [a, a2]
  iff not (shiftLimits [a.toLower, a.toUpper, a2.toLower, a2.toUpper] and equalFromLimits [a, a2])
}
...
assert equalLimits {
  all disj a, a2 : Limited |
    equalLimits [a, a2] iff equalFromLimits [a, a2] and equalToLimits [a, a2]
}
